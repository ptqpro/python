...
def main():
    ...
    print("\n"*2)
    print(Colorate.Horizontal(Colors.green_to_yellow, Center.XCenter(text)))
    print("\n"*5)


    file = Write.Input("Nhập File Cần Enc -> ", Colors.green_to_yellow, interval=0.005)
    ...
    file = file.removesuffix(".py") + "-qhuy.py" # hello hideaki
...
Making the final content..."""))
    ...
    print('\n')
    Write.Print(f"Lưu tại file: "+file+"",Colors.green_to_yellow, interval=0.005)
    return exit()
