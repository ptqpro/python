...
import threading
import time
__AUTHOR__ = 'Minh Quan'
__VERSION__ = '0.0.1'
def banner():
    print(f''' 
       \033[1m\033[38;5;237m[\033[38;5;54m*\033[38;5;237m] \033[4m\033[38;5;164mAuthor: {__AUTHOR__}\033[0m                     \033[1m\033[38;5;237m[\033[38;5;54m*\033[38;5;237m] \033[4m\033[38;5;164mVersion: {__VERSION__} \033[0m                                                                                               ''')
def clear():
...
def main_share():
    clear()
    banner()
    input_file = open(input("\033[1m\033[38;5;51mInput File Cookies: \033[1;35m")).read().split('\n')
    id_share = input("\033[1m\033[38;5;51mInput ID Share: \033[1;35m")
    total_share = int(input("\033[1m\033[38;5;51mInput Taltal Share: \033[1;35m"))
    delay = int(input("\033[1m\033[38;5;51mInput Delay Share: \033[1;35m"))
    ...
    total_live = len(all)
    print(f'\033[1m\033[38;5;51mLive: {total_live} Cookies')
    if total_live == 0:
        sys.exit()
    print('\033[1m\033[38;5;51m════════════════════════════════════\033[0m')
    stt = 0
