...
def fakeEmail():
  faker = Faker()
  print ('')
  print ('             \033[1;34m[ Tool Đào Mmail ]')
  print ('')
  data_kytu = [ '_', '.']
  so_luong = int(input(" \033[1;34m➻❥ Nhập Số Lượng : "))
  Domain = input(" \033[1;34m➻❥ Nhập Domain(ex: yahoo) : ")
  print  (' Nếu Bạn Thích Kí Tự Nào Thì Nhập Kí Tự Đó lưu ý yahoo chỉ sài đc _ với .    ')
  print (' Nếu Bạn Không Thích Kí Tự Nào Hết Thì Bấm enter nhá  ') 
  kitu = input (" \033[1;96m Nhập Kí Tự Đuôi Mail Vd hshshhshs@yahoo.com đuôi mail là shs : ")
  kitt = input ("\ 033[1;96m Nhập Kí Tự Ở Giữa vd hshh nhập kí tự _hoặc. ở trên cũng thế : ")
  ...
  for fake in range(so_luong):
    ...
    fake_email = first_name + kitt + last_name + kitu + str(num) + '@' + Domain + '.com'
    print (" [" + str(n) + "] ➻❥ |MH-Q|" + fake_email)
...
def checkhotmail():
  print ('')
  print ('             \033[1;34m[ Tool Loc Die/Live Hotmail ]')
  print ('')
  try:
  ...
  def run_check_hotmail(hot_mail):
    ...
    if kq == None:
      print (" \033[1;31m➻❥ |\033[1;37mLXC-ĐZ\033[1;31m|Email Live|" + hot_mail + "@hotmail.com")
      open(hotmail_live,'a').write(hot_mail + "@hotmail.com" + "\n")
    else:
      print (" \033[1;32m➻❥ |\033[1;37mLXC-ĐZ\033[1;32m|Email Die|" + hot_mail + "@hotmail.com")
...
def checkyahoo():
  print ("")
  print ("             \033[1;34m[ Tool Loc Die/Live Yahoo ]")
  print ("")
  try:
    print (" \033[1;34m➻❥ CÓ THỂ NHẬP ĐỊNH DẠNG MAIL|PASS")
    n_yahoo = 0
  ...
  def run_check_yahoo(yid):
    ...
    if KQ == None:
      print(" \033[1;32m➻❥ |\033[1;37mLXC-ĐZ\033[1;32m|Email Die| " + yid + "@yahoo.com")
      open(yahoo_die,"a").write(yid + "@yahoo.com" + "\n")
    else:
      print(" \033[1;31m➻❥ |\033[1;37mLXC-ĐZ\033[1;31m|Email Live| " + yid + "@yahoo.com")
...
def checkvalid():
  print ('')
  print ('             \033[1;34m[ Tool Loc Lien Ket Facebook ]')
  print ('')
  try:
    ...
    print ("   \033[1;93m•MỖI IP CHECK ĐƯỢC 100-200 MAIL RỒI ĐỔI IP KHÁC")
  ...
  def run_check_valid(emailfb):
    ...
    if kq_check == None:
      print (" \033[1;32m➻❥ |\033[1;37mMH-Q\033[1;32m| Có Liên Kết |" + emailfb)
      open(valid,"a").write(emailfb + "\n")
    else:
      print (" \033[1;31m➻❥ |\033[1;37mMH-Q\033[1;31m| Không Liên Kết |" + emailfb)
  with concurrent.futures.ThreadPoolExecutor() as executor:
...
def logo():
  logo = """
        ...
        \033[1;93m░▐██████▌╬   \033[1;35m 
                  ...
                  \033[0;33m➻❥ Copyright By : Lưu Xuân Chúc 
                  \033[1;34m➻❥ Zalo : 0972203182
                  \033[1;32m➻❥ Facebook : ( Không Có )
"""
...
def process_menu():
  menu = """
                ...
                \033[1;31m[-----------------------------]
                      ...
                      \033[1;32m2. Tool Loc Die/LiveHotmail.
                      \033[1;33m3. Tool Loc Die/Live Yahoo.
                      \033[1;34m4. Tool Loc Lien Ket Facebook.
